    ...
    \begin{itemize}
      ...
      \item They\ldots
        \begin{enumerate}
          ...
          \item Rise a and repeat a few million, billion, trillion\ldots times before something useful happens
        \end{enumerate}
        \pause
...
\begin{frame}
  ...
  \begin{itemize}
    \item Homework 1 will be posted tommorow and cover things from topic 1.
    \item The (zyBooks) topic 1 participation and (PrairieLearn) post-reading activities are due tonight.
    \item Topic 2 (Part 1) post-reading and participation activities will be due Friday night.
  \end{itemize}
\end{frame}
